...
const ButtonContact = () => {
  ...
  return (
    <div className="get-in-touch-container" >
      ...
      <div className="get-in-touch-button" onClick={toggleOpen}>   Get In Touch</div>
      {isContactOpen && (
        <div className="contact-window-g" >
          <div className="contact-window" >
            <div className="contact-container" >
              <div className="get-button-cont">
                ...
                <div className="text-get-1">GET IN TOUCH</div>
                <div className="text-get-2">I'm always open to discuss new projects.</div>
              </div>
